...
- ### Structure —
    1. **[templates](https://github.com/suvrashaw/iris-classification-flask/tree/main/templates)**: The HTML files are kept in this folder. 
    2. **[static](https://github.com/suvrashaw/iris-classification-flask/tree/main/static)**: Static files, such as images, are stored in this folder.
    3. [Dataset.csv](https://github.com/suvrashaw/iris-classification-flask/blob/main/Dataset.csv): This is the sample dataset, converted to csv. Download the Dataset from [Here](https://www.kaggle.com/uciml/iris/download)
    4. **[app.py](https://github.com/suvrashaw/iris-classification-flask/blob/main/app.py)**: This is a python file that contains the code for our application. The Flask Server is started here.
    5. **[iri.pkl](https://github.com/suvrashaw/iris-classification-flask/blob/main/iri.pkl)**: This is the pickel file, which has been saved as a model.
    6. **[iris.py](https://github.com/suvrashaw/iris-classification-flask/blob/main/iris.py)**: The model is created in this python file.
