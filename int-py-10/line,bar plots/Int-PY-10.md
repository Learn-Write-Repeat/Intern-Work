...
### Creating a Figure Containg Single Axes
...
```python
#Creating a Figure Containg 2 axes
#Example1
x = np.array([1, 3, 6, 9])  # X-axis points
y = np.array([1,6,3,9])
plt.plot(x, y,linestyle = 'dashed',linewidth=2,color = 'black')
#we can use many Linestyles,colors and adjust the thickness
plt.show() 
```
